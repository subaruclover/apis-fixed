...
inputData = pd.read_csv("sample_acc_60.csv")
...
pvc_e001_plot = ax0.plot(pvc_e001[:24*7], 'm*-', label="PV E001")
load_e001_plot = ax0.plot(load_e001[:24*7], 'y--', label="Load E001")
p2_e001_plot = ax0.plot(p2_e001[:24*7], 'b', label="p2 E001")
rsoc_e001_plot = ax0_2.plot(rsoc_e001[:24*7], 'g', label="RSOC E001")
# ax0.set_xlabel("Hour")
...
pvc_e002_plot = ax1.plot(pvc_e002[:24*7], 'm*-', label="PV E002")
load_e002_plot = ax1.plot(load_e002[:24*7], 'y--', label="Load E002")
p2_e002_plot = ax1.plot(p2_e002[:24*7], 'b', label="p2 E002")
rsoc_e002_plot = ax1_2.plot(rsoc_e002[:24*7], 'g', label="RSOC E002")
# ax1.set_xlabel("Hour")
...
pvc_e003_plot = ax2.plot(pvc_e003[:24*7], 'm*-', label="PV E003")
load_e003_plot = ax2.plot(load_e003[:24*7], 'y--', label="Load E003")
p2_e003_plot = ax2.plot(p2_e003[:24*7], 'b', label="p2 E003")
rsoc_e003_plot = ax2_2.plot(rsoc_e003[:24*7], 'g', label="RSOC E003")
# ax2.set_xlabel("Hour")
...
pvc_e004_plot = ax3.plot(pvc_e004[:24*7], 'm*-', label="PV E004")
load_e004_plot = ax3.plot(load_e004[:24*7], 'y--', label="Load E004")
p2_e004_plot = ax3.plot(p2_e004[:24*7], 'b', label="p2 E004")
rsoc_e004_plot = ax3_2.plot(rsoc_e004[:24*7], 'g', label="RSOC E004")
ax3.set_xlabel("Hour")
